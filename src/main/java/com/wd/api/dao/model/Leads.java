...
public class Leads {
    ...
    @Column(name = "lead_id") // Assuming DB column is lead_id based on POJO field
    @JsonProperty("lead_id")
    private Long id; // ID should usually be Long or UUID. POJO had String leadId. Checking usage.

    // Original POJO had String leadId. If DB is bigserial/serial (integer), it
    // should be Long.
    // If it is UUID, it should be UUID.
    // LeadController.java line 131: getLeadById(@PathVariable String leadId)
    // LeadsDAO.java line 133: public Leads getLeadById(String leadId)
    // AND LeadController line 152: // lead_id will be auto-generated by database
    // (bigserial)
    // So it is BigSerial (Long). But POJO had it as String.
    // I will change it to Long for JPA best practices, but keep JSON property
    // consistent.
