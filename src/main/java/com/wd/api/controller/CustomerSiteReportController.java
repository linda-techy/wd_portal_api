...
public class CustomerSiteReportController {
     ...
     * @return Paginated list of site reports with photos
     */
    @GetMapping
    public ResponseEntity<ApiResponse<Page<SiteReport>>> getCustomerSiteReports(
     ...
     * @return Site report with all photos
     */
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<SiteReport>> getSiteReportById(@PathVariable Long id) {
        try {
            CustomerUser currentCustomer = authService.getCurrentCustomerUser();
