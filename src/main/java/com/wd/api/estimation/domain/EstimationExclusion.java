...
@Entity
@Table(name = "estimation_exclusion")
@SQLDelete(sql = "UPDATE estimation_exclusion SET deleted_at = NOW() WHERE id = ? AND version = ?")
@Where(clause = "deleted_at IS NULL")
public class EstimationExclusion extends BaseEntity {
