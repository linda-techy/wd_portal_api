...
@Entity
@Table(name = "estimation_assumption")
@SQLDelete(sql = "UPDATE estimation_assumption SET deleted_at = NOW() WHERE id = ? AND version = ?")
@Where(clause = "deleted_at IS NULL")
public class EstimationAssumption extends BaseEntity {
