...
@Entity
@Table(name = "estimation_inclusion")
@SQLDelete(sql = "UPDATE estimation_inclusion SET deleted_at = NOW() WHERE id = ? AND version = ?")
@Where(clause = "deleted_at IS NULL")
public class EstimationInclusion extends BaseEntity {
